...
aluguel indice armarios = 
  case pegarArmario indice armarios of
    Right (estado,codigo)  -> Right (Map.insert indice (Alugado,codigo) armarios)
    Left string -> Left string
...
devolucao indice codigo armarios = 
  case pegarArmario indice armarios of
    Left string -> Left string
    Right (estado,codigo1) -> if estado /= Livre 
                     then if codigo1==codigo then Right (Map.insert indice (Livre,codigo1) armarios) else Left $ "codigo incorreto"
                     else Left $ "armario "++ show indice++ " esta desocupado"
